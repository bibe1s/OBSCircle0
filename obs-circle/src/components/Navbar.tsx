...
import obsLogo from '../assets/images/obslogo.svg';
...
const Navbar: FC = () => {
  ...
  return (
    <header className="bg-white dark:bg-black text-gray-800 dark:text-white shadow-md transition-colors duration-300">
